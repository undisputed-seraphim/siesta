...
void V3Printer::print_server(const std::filesystem::path& output_dir) {
...
void V3Printer::print_server_hpp() {
...
void V3Printer::print_dispatcher_function(std::string className) {
	auto& out = srv_cpp_ofs;
