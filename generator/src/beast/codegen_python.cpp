...
void BeastPythonGenerator::operator()(const CodegenArgs& args, const std::filesystem::path& output_dir) {
...
void BeastPythonGenerator::emitModulePreamble(std::ostream& out, const std::string& module_name) {
...
void BeastPythonGenerator::emitEndpointWrapper(std::ostream& out, const Endpoint& ep, bool is_last) {
...
void BeastPythonGenerator::emitModuleBody(std::ostream& out, const std::vector<Endpoint>& endpoints) {
